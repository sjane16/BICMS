...
function Dlreportcomp({ onClose }) {
    ...
    const downloadCertReport = async () => {
        try {
            const res = await fetch("http://localhost/bicms_backend/generatecompreport.php", {
                method: "POST",
            ...
            a.href = url;
            a.download = "Complaint_Reports.pdf";
            a.click();
            ...
            <div className="DLReport-container">
                <div className="DLReport-header-dismiss">
                    <div className="first-row-header">
                        ...
                        <h1 className="h1-DLReport-header"> Download Complaints Report?</h1>
                    </div>
                </div>
                <div className="DLReport-body">
                    <h2 className="h2-dismiss-header">Do you want to generate a file for complaint report?</h2>
                </div>
